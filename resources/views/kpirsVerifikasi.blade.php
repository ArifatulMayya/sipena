...
<head>
  ...
  <title> VERIFIKASI IRS - SIPENA UNDIP </title>
...
<div class="flex pt-12"> 
  ...
  <div class="w-full p-6">
    <h1 class="text-2xl font-bold mb-4">Verifikasi IRS</h1>
      ...
      <tbody>
        <tr class="border-b">
          ...
          <td class="p-2 text-center">
            <a href="/transkripMhs" class="px-4 py-2 bg-orange-500 text-white rounded-lg">Detail</a>
          </td>
          <td class="p-2 text-center">Berhasil</td>
        </tr>
        <tr class="border-b">
          ...
          <td class="p-2 text-center">Gagal</td>
        </tr>
        <tr class="border-b">
        ...
        <tr class="border-b">
          ...
          <td class="p-2 text-center">
            <button class="bg-green-400 w-24 py-1 rounded-lg">Setujui</button>
            <button class="bg-red-600 w-24 py-1 rounded-lg">Tidak</button>
          </td>
        </tr>
        <tr class="border-b">
