...
<nav class="w-1/4 bg-[#10296E] text-white h-screen p-4">
    ...
    <aside>
          <ul class="space-y-2">
             <li class="mx-4 py-2">
                 <a href="/dashboardPA" class="block hover:bg-[#2D4995] hover:font-bold rounded-lg px-4 py-2 ">Dashboard</a>
             </li>
             <li class="mx-4 py-2">
                 <a href="/dosenBimbingan" class="block hover:bg-[#2D4995] hover:font-bold rounded-lg px-4 py-2 font-bold">Bimbingan Non-TA</a>
             </li>
             <li class="mx-4 py-2">
