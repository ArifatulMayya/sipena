    ...
    <div class="flex">
        ...
        <aside class="w-[17%] h-[68vh] ml-12 mt-4 bg-[#10296E] text-white py-6 rounded-2xl font-bold text-center">
            <ul class="space-y-2">
                ...
                <li class="mx-4 py-2">
                    <a href="/dekanPersetujuanRuang" class="block hover:bg-[#2D4995] rounded-lg px-4 py-2">Persetujuan Ruang</a>
                </li>
                <li class="mx-4 py-2">
                    <a href="/dekanPersetujuanJadwal" class="block hover:bg-[#2D4995] rounded-lg px-4 py-2">Persetujuan Jadwal</a>
                </li>
            </ul>
        </aside>
        ...
        <div class="w-[83%] h-[68vh]">
            ...
            <div class="bg-[#AEC0F1] text-white p-6 mx-6 rounded-2xl grid grid-cols-2 font-bold text-center">
                <div class="bg-[#10296E] py-6 rounded-l-xl border-r">
                    <h1 class="text-xl font-normal">Jumlah Pengajuan Jadwal</h1>
                    <h1 class="text-3xl mt-4 pt-4 border-t">{{$totalJadwal}}</h1>
                </div>
                <div class="bg-[#10296E] py-6 rounded-r-xl">
                    <h1 class="text-xl font-normal">Pengajuan Jadwal Disetujui</h1>
                    <h1 class="text-3xl mt-4 pt-4 border-t">{{$approvedJadwal}}</h1>
                </div>
            </div>
            ...
            <div class="bg-[#AEC0F1] text-white p-6 mx-6 rounded-2xl grid grid-cols-2 font-bold text-center">
                <div class="bg-[#10296E] py-6 rounded-l-xl border-r">
                    ...
                    <h1 class="text-3xl mt-4 pt-4 border-t">{{ $totalRuang }}</h1> <!-- Display total rooms -->
                </div>
                <div class="bg-[#10296E] py-6 rounded-r-xl">
                    <h1 class="text-xl font-normal">Pengajuan Ruang Disetujui</h1>
                    <h1 class="text-3xl mt-4 pt-4 border-t">{{ $approvedRuang }}</h1> <!-- Display approved rooms -->
                </div>
            </div>
